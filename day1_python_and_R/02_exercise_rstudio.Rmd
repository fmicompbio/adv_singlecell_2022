...
if (grepl(".fmi.ch$", Sys.info()["nodename"])) {
    ...
    Sys.setenv(RETICULATE_PYTHON = "/home/rstudio/.local/share/r-miniconda/envs/day1_RNA_velocity/bin/python3")
    
    # Sys.setenv(RETICULATE_PYTHON = "/Users/stadler/miniforge3/bin/python3")

    # use_python("~/miniforge3/bin/python")
    # use_condaenv("base")

    # https://github.com/rstudio/reticulate/issues/456#issuecomment-1046045432
    # Sys.setenv(OPENBLAS = "/Users/stadler/miniforge3/lib/libblas.dylib")
