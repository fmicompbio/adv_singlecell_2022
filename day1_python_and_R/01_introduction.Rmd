...
library(reticulate)
if (grepl(".fmi.ch$", Sys.info()["nodename"])) {
    # Sys.setenv(PYTHONPATH = "/tungstenfs/groups/gbioinfo/stadler/documents/teaching/adv_singlecell_2022/pythonlib")
    # Sys.setenv(RETICULATE_PYTHON = "/usr/bin/python3.6") # use system python 3.6
    # systemPipeR::moduleload("Miniconda3/4.10.3")
    # reticulate::use_python("/tungstenfs/groups/gbioinfo/stadler/documents/teaching/adv_singlecell_2022/day1_python_and_R/pythonenv/bin/python")
    Sys.setenv(PYTHONPATH = "/tungstenfs/groups/gbioinfo/stadler/documents/teaching/adv_singlecell_2022/day1_python_and_R/pythonenv/lib/python3.9/site-packages/")
    reticulate::use_condaenv("/tungstenfs/groups/gbioinfo/stadler/documents/teaching/adv_singlecell_2022/day1_python_and_R/pythonenv/bin/python")
}
